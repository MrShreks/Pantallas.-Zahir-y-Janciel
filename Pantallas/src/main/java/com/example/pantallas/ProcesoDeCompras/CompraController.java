...
public class CompraController {
    ...
    private void asegurarTablaProductos() {
        ...
        try (Connection con = DriverManager.getConnection(URL, USER, PASS);
            ...
            System.out.println("No se pudo crear/seed tbl_suplidor_productos: " + e.getMessage());
        }
    }
    ...
    private void seedProductos(Connection con) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            ps.executeBatch();
        } catch (Exception e) { System.out.println("No se pudo seed productos: " + e.getMessage()); }
    }
    ...
    private void cargarProductosPorSuplidor(String suplidorNombre) {
        ...
        } catch (Exception e) { System.out.println("Error cargando factores_conversion: " + e.getMessage()); }
    ...
    @FXML private void generarOrden() {
        ...
        } catch (Exception e) { e.printStackTrace(); mostrarAlerta("Error de Base de Datos", "No se pudo generar la orden."); }
    }
    ...
    @FXML private void confirmarRecepcion() {
        ...
        } catch (Exception e) { e.printStackTrace(); mostrarAlerta("Error de Base de Datos", "No se pudo registrar la recepción."); }
    }
